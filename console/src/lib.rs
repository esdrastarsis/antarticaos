...
mod tests {
    ...
    fn write_multiple_words() {
        ...
        vga.write_str("ola ").unwrap();
        vga.write_str("mundo").unwrap();

        assert_eq!(vga.buffer[0], 'o' as u8);
        assert_eq!(vga.buffer[1], 0x02);
        assert_eq!(vga.buffer[2], 'l' as u8);
        assert_eq!(vga.buffer[3], 0x02);
        assert_eq!(vga.buffer[4], 'a' as u8);
        assert_eq!(vga.buffer[5], 0x02);
        assert_eq!(vga.buffer[6], ' ' as u8);
        assert_eq!(vga.buffer[7], 0x02);
        assert_eq!(vga.buffer[12], 'm' as u8);
        assert_eq!(vga.buffer[13], 0x02);
        assert_eq!(vga.buffer[14], 'u' as u8);
        assert_eq!(vga.buffer[15], 0x02);
        assert_eq!(vga.buffer[16], 'n' as u8);
        assert_eq!(vga.buffer[17], 0x02);
        assert_eq!(vga.buffer[18], 'd' as u8);
        assert_eq!(vga.buffer[19], 0x02);
        assert_eq!(vga.buffer[20], 'o' as u8);
    ...
    fn write_scroll() {
        ...
        assert_eq!(vga.buffer[4], 'a' as u8);
        assert_eq!(vga.buffer[5], 0x02);
        assert_eq!(vga.buffer[160], 'm' as u8);
        assert_eq!(vga.buffer[161], 0x02);
        assert_eq!(vga.buffer[162], 'u' as u8);
        assert_eq!(vga.buffer[163], 0x02);
        assert_eq!(vga.buffer[164], 'n' as u8);
        assert_eq!(vga.buffer[165], 0x02);
        assert_eq!(vga.buffer[166], 'd' as u8);
        assert_eq!(vga.buffer[167], 0x02);
        assert_eq!(vga.buffer[168], 'o' as u8);
        assert_eq!(vga.buffer[169], 0x03);
